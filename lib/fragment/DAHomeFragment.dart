...
import 'package:dating_app/components/DiscoverBottomSheetWidget.dart';
import 'package:dating_app/model/DatingAppModel.dart';
import 'package:dating_app/screen/DAZoomingScreen.dart';
import 'package:dating_app/utils/DAColors.dart';
import 'package:dating_app/utils/DADataGenerator.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        ...
        showBack: false,
        actions: [
          Icon(Icons.sort,color: primaryColor,).paddingOnly(right: 16).onTap(() {
