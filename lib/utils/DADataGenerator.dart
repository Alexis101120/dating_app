import 'package:dating_app/model/DatingAppModel.dart';
...
List<DatingAppModel> getSettingData() {
  List<DatingAppModel> list = [];
  list.add(DatingAppModel(name: 'Edit your profile',widget: PurchaseMoreScreen()));
  list.add(DatingAppModel(name: 'Change your password', widget: PurchaseMoreScreen()));
  list.add(DatingAppModel(name: 'Change your location', widget: PurchaseMoreScreen()));
  list.add(DatingAppModel(name: 'Notifications', widget: PurchaseMoreScreen()));
